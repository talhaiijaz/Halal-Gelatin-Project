    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (errorStr.includes("validation") || errorStr.includes("invalid")) {
          errorMessage = "Invalid payment data. Please check the payment information and try again.";
        } else if (errorStr.includes("permission") || errorStr.includes("unauthorized")) {
          errorMessage = "You don't have permission to delete payments. Please contact your administrator.";
        } else if (errorStr.includes("not found") || errorStr.includes("doesn't exist")) {
          errorMessage = "Payment not found. The payment may have already been deleted.";
        } else if (errorStr.includes("constraint") || errorStr.includes("foreign key") || errorStr.includes("reference")) {
          errorMessage = "Cannot delete this payment because it has associated records. Please remove these records first.";
