...
export default function OutsourceDetailPage() {
  ...
  const deleteOutsourceBatch = useMutation(api.outsourceBatches.deleteOutsourceBatch);
  ...
  const handleDeleteBatch = async (batchId: Id<"outsourceBatches">) => {
    ...
    if (confirm("Are you sure you want to delete this batch?")) {
      try {
        await deleteOutsourceBatch({ batchId: batchId });
  ...
  const handleDeleteSelected = async () => {
    ...
    try {
      const batchIds = deletableBatches as Id<"outsourceBatches">[];
